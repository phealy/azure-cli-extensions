...
from azext_login_interactive_ssh._help import helps  # pylint: disable=unused-import


class Login_interactive_sshCommandsLoader(AzCommandsLoader):
    ...
    def load_arguments(self, command):
        from azext_login_interactive_ssh._params import load_arguments
        load_arguments(self, command)


COMMAND_LOADER_CLS = Login_interactive_sshCommandsLoader
