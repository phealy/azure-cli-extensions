...
def load_arguments(self, _):
    ...
    fzf_if_needed_type = CLIArgumentType(options_list=['--if-needed'], help='Only install fzf if not found in path.', id_part='if-needed')
    ...
    with self.argument_context('fzf install') as command:
        ...
        command.argument('if_needed', fzf_if_needed_type)
